// Hardcoded constituent lists for the swing screener universe.
//
// These lists are public and change infrequently — refresh roughly once a
// quarter. The screener tolerates minor drift: a few stale symbols will
// just fail Yahoo lookup and get logged as errors, while a few missing
// names just shrink the search universe.
//
// Sources:
//   S&P 500    — https://en.wikipedia.org/wiki/List_of_S%26P_500_companies
//   Nasdaq 100 — https://en.wikipedia.org/wiki/Nasdaq-100
// Snapshot taken: 2026-Q1 reconstitution.
//
// Symbols use Yahoo's dot-form (BRK-B, BF-B) — that's what yahoo-finance2
// expects on US tickers with class shares.
...
export const SP500_SYMBOLS: string[] = [
  ...
  "RVTY", "RDDT", "ROK", "ROL", "ROP", "ROST", "RCL", "SPGI", "CRM", "SBAC",
  ...
  "VLTO", "VRSN", "VRSK", "VZ", "VRTX", "VTRS", "V", "VST", "VMC", "WRB",
...
export const NASDAQ100_SYMBOLS: string[] = [
  ...
  "CTAS", "CSCO", "CCEP", "CEG", "CPRT", "CSGP", "COST", "CRWD", "CSX",
  "DDOG", "DXCM", "FANG", "DASH", "EA", "EXC", "FAST", "FTNT", "GEHC",
  "GILD", "GFS", "HON", "IDXX", "INTC", "INTU", "ISRG", "KDP", "KLAC",
  "KHC", "LRCX", "LIN", "LULU", "MAR", "MRVL", "MELI", "META", "MCHP",
  "MU", "MSFT", "MSTR", "MDLZ", "MNST", "NFLX", "NVDA", "NXPI", "ORLY",
  "ODFL", "ON", "PCAR", "PLTR", "PANW", "PAYX", "PYPL", "PEP", "PDD",
  "QCOM", "REGN", "ROP", "ROST", "SBUX", "SHOP", "SNPS", "TTWO", "TMUS",
  "TSLA", "TXN", "TTD", "VRSK", "VRTX", "WBD", "WDAY", "XEL", "ZS",
];

// SWING_UNIVERSE — deduplicated union of both indexes. Used as the input
// universe for the swing screener Pass 1 scan.
export const SWING_UNIVERSE: string[] = (() => {
  const seen = new Set<string>();
  const out: string[] = [];
  for (const s of [...SP500_SYMBOLS, ...NASDAQ100_SYMBOLS]) {
